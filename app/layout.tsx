...
export const metadata: Metadata = {
  title: 'Garage Guide — Your vehicle life, organized',
  description: 'A private, local-first home for vehicle documents, deadlines, and maintenance records.',
  manifest: './manifest.webmanifest',
  icons: { icon: './favicon.svg', apple: './apple-touch-icon.png' },
  appleWebApp: { capable: true, statusBarStyle: 'black-translucent', title: 'Garage Guide' },
  openGraph: {
    title: 'Garage Guide',
  ...
  twitter: { card: 'summary_large_image', title: 'Garage Guide', description: 'Your vehicle life, organized.', images: ['./og.png'] },
};
